...
<div class="profile-tabular--wrapper">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="flex">
                        <div class="info-input">
                            <span>Username</span>
                            <input type="text" name="user" value="<?php echo isset($pdoResult[0]['username']) ? $pdoResult[0]['username'] : ''; ?>" required placeholder="Username" class="info-inputbox">
                            <span>Email</span>
                            <input type="email" name="email" value="<?php echo isset($pdoResult[0]['email']) ? $pdoResult[0]['email'] : ''; ?>" required placeholder="Email" class="info-inputbox">
                            <span>Full name</span>
                            <input type="text" name="fname" value="<?php echo isset($pdoResult[0]['fullname']) ? $pdoResult[0]['fullname'] : ''; ?>" required placeholder="Fullname" class="info-inputbox">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <a href="Admin.php" class="profile-btn">Back</a>
    </div>
    </form>
    </div>
    </div>
