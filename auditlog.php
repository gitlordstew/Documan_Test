...
if (!empty($selectedLogType)) {
    switch ($selectedLogType) {
        ...
        case 'Uploaded file:':
            ...
            break;
        case 'Updated user details.':
            $pdoQuery .= " WHERE iolog LIKE 'Updated user details.'";
            break;
        case 'Created folder:':
            $pdoQuery .= " WHERE iolog LIKE 'Created folder:%'";
            break;
        case 'Deleted user with ID:':
            $pdoQuery .= " WHERE iolog LIKE 'Deleted user with ID:%'";
            break;
        case 'Deleted file:':
            $pdoQuery .= " WHERE iolog LIKE 'Deleted file:%'";
            break;
    }
}
                    ...
                    <div class="row">
                        <div class="filter-container">
                            ...
                            <select id="log-filter" name="iolog" required class="form-select">
                                ...
                                <option value="Updated user details." <?= $selectedLogType == "Updated user details." ? "selected" : "" ?>>Updated user details</option>
                                <option value="Created folder:" <?= $selectedLogType == "Created folder:" ? "selected" : "" ?>>Created folders</option>
                                <option value="Deleted user with ID:" <?= $selectedLogType == "Deleted user with ID:" ? "selected" : "" ?>>Deleted users</option>
                                <option value="Deleted file:" <?= $selectedLogType == "Deleted file:" ? "selected" : "" ?>>Deleted files</option>
                            </select>
                            <button type="submit" class="tbl_btn">Filter</button>
                            <a href="auditlog.php" class="tbl_btn">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
