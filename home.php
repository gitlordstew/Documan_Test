...
if (isset($_SESSION["username"]))
{
    ...
    <div class="main--content">
        ...
        $sqlSuperadmins = "SELECT COUNT(id) FROM tbuser WHERE role = 'SuperAdmin'";
        $stmtSuperadmins = $pdoConnect->query($sqlSuperadmins);
        $numberOfSuperadmins = $stmtSuperadmins->fetchColumn();

            // Display the number of Super Admins
        echo '
            <div class="card--numthree">
                <div class="card--header">
                    <div class="no--user">
                        <span class="title">Super Admins <i class="fa-solid fa-user-tie icon-super"></i></span>
                        <span class="user--value">' . htmlspecialchars($numberOfSuperadmins) . '</span>
                    </div>
                </div>
            </div>
        ';
        ...
        echo '
        <div class="dash-tabular--wrapper">
            <h3 class="dash-main--title">Recents</h3>
